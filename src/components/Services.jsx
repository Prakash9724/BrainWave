      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute w-full left-0 top-0 h-full pointer-events-none md:w-3/5 xl:w-auto">
              <img
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute flex flex-col justify-end p-8 
              inset-0 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                ...
                <div className="relative  h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                        <img src={service3} width={520} height={400} className="h-full w-full object-cover" alt="Scary Robot" />
